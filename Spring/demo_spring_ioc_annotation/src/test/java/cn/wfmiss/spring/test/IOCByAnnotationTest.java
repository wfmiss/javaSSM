...
public class IOCByAnnotationTest {
     ...
     *
     * 通过注解+扫描所描述的bean的id，默认值为类的小驼峰，即类名的首字母为小写的结果
     * 可以通过标识组件的注解value属性设置bean的自定义的id
     *
     ...
     * c>若byType和byName的方式都无妨实现自动装配，即IOC容器中有多个类类型匹配的bean
     ...
     * 在@Aotuwired注解中有个属性required，默认值为true，要求必须完成自动装配
     * 可以将required设置成false，此时能装配则装配，无法装配则使用属性的默认值
     */
